# AI WARLORDS — RISK REGISTER (M011)

> Data: 2026-09-11 · Actualizado por: M011
...
| R-02 | Complexidade prematura               | 0–2     | Alta | FUTURE | §19; M002–M011 minimalistas provam o padrão            |
...
| R-31 | Double-spend / reconciliação        | 23–25 | Crítica | FUTURE | §11; M009: selo transversal; zero simulação           |
| R-05 | Testes desactivados para obter PASS | Todas | Alta    | FUTURE | §16; thresholds enforced; exclusão só com compensação |
...
| R-51 | Docker ausente no sandbox                    | Baixa | ACTIVE    | M011 não precisou; revisitar se preciso                                       |
