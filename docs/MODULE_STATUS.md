...
| Estado     | Contagem       |
| ---------- | -------------- |
| `VERIFIED` | 90 (M001–M090) |
| `PLANNED`  | 75 (M091–M165) |
| Outros     | 0              |
...
- **M040 @ 2026-09-11** — AI Assessment Events (1.º
...
- **M046 @ 2026-09-11** — AI Refutation Data
  ...
  ABERTO.
- **M047 @ 2026-09-11** — AI Override
  (substituição votada: head+fresh, facto
...
- **M067 @ 2026-09-12** — AI Arena Scoring
...
- **M071 @ 2026-09-12** — Multiplayer
  Lobby (lista/fecho/lifecycle,
  bundle +0); 1892/1892 testes, 100
  global.
  Registo em `docs/modules/M071.md`.
- **M072 @ 2026-09-12** — Multiplayer
  Deploy (entry+Render API+CORS,
...
| M083 | Security (headers) | `VERIFIED` |
| M084 | Security (audit) | `VERIFIED` |
...
| M091–M093 | Observability | `PLANNED` |
